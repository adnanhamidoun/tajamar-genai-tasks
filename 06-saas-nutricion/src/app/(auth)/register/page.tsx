  ...
  return (
    ...
    >
      <div className="text-center">
        <h2 className="text-4xl font-black uppercase italic tracking-tighter text-white">Únete</h2>
        <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mt-2">Inicia tu transformación hoy</p>
      </div>
      ...
      <form onSubmit={handleRegister} className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-2">Nombre de Agente</Label>
            <div className="relative">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-700" />
              <Input
          ...
          {/* Email */}
          <div className="space-y-2">
            <Label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-2">Email Operativo</Label>
            <div className="relative">
              <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-zinc-700" />
              <Input
                type="email"
                placeholder="tu@mision.com"
                value={email}
          ...
          {/* Password */}
          <div className="space-y-2">
            <Label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-2">Contraseña de Cifrado</Label>
            <div className="relative">
          ...
          {/* Confirm Password */}
          <div className="space-y-2">
            <Label className="text-[10px] font-black uppercase tracking-widest text-zinc-600 ml-2">Validar Contraseña</Label>
            <Input
              type={showPassword ? "text" : "password"}
              placeholder="••••••••"
              ...
              required
              className="h-16 bg-zinc-950 border-zinc-900 focus:border-brand rounded-[24px] px-6 text-white font-mono font-bold transition-all"
              disabled={loading}
            />
          </div>
        </div>
        ...
        >
          ...
          {loading ? "Creando Perfil..." : "CREAR IDENTIDAD"}
        </Button>
      </form>
